/* file: amm_personalisedBlocks.js - v1.0.0 | minified on 2011/01/28 with http://jscompress.com/ */
...
{if(items=='')
{$('#iamm_personalised_nfo').inputText('value','');$('#iamm_personalised_title').inputText('value','').inputText('languagesValues',{});$('#iamm_personalised_content').inputText('value','').inputText('languagesValues',{});$('#iamm_personalised_visible').inputRadio('value','y');}
else
...
$('#iamm_personalised_nfo').inputText('value',tmp.nfo);$('#iamm_personalised_title').inputText('languagesValues',titles);$('#iamm_personalised_content').inputText('languagesValues',contents);$('#iamm_personalised_visible').inputRadio('value',tmp.visible);}},doUpdate=function()
{displayProcessing(true);var langs=[],titles=$('#iamm_personalised_content').inputText('languagesValues'),contents=$('#iamm_personalised_title').inputText('languagesValues');for(var lang in titles)
