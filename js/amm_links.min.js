/* file: amm_links.js - v1.0.0 | minified on 2011/01/28 with http://jscompress.com/ */
...
{$("#iList table.littlefont").sortable('destroy');$('#iList').html("<br>"+translatedKeys.g002_loading+"<br><img src='./plugins/GrumPluginClasses/icons/processing.gif'>");$.ajax({type:"POST",url:options.ajaxUrl,async:true,data:{ajaxfct:"admin.links.list"},success:function(msg)
...
{if(properties.id!='')
{displayProcessing(true);$.ajax({type:"POST",url:options.ajaxUrl,async:true,data:{ajaxfct:"admin.links.get",id:properties.id},success:function(msg)
